    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_template', models.CharField(default='Your Sand & Sky booking {{ booking.reference_code }} is confirmed', help_text='Django template for the email subject (e.g. {{ booking.reference_code }}).', max_length=200)),
